...
excerpt: "As the State deploys a gamut of surveillance technologies to monitor
  ...
  biometric identifier, across education, banking, telecoms, tax, welfare is
  clear. "
...
**Aadhaar causes exclusion from welfare across states:** 

* **People with disabilities continue to suffer:** An Odisha labourer and his son have been [excluded from welfare schemes](https://www.etvbharat.com/en/state/no-fingerprints-no-aadhaar-odisha-man-long-struggle-with-rare-disease-enn26090205984) for years due to a genetic condition which has left them without fingerprints.

* **Rural life disruptions** from [Aadhaar’s functional failures](https://www.bhaskar.com/local/uttar-pradesh/bareilly/sharifnagar/news/shergarh-csc-center-aadhaar-update-server-issue-power-cut-problem-138763681.html): Reports from near Bareilly, Uttar Pradesh show how people are forced to travel from faraway places and wait for hours due to slow server speeds and frequent power outages.

* In Bihar, the Aadhaar center at Terhagacch block, Kishanganj district was [closed for five days](https://www.bhaskar.com/local/bihar/kishanganj/terhagachh/news/aadhaar-centre-closed-for-five-days-villagers-upset-dbp-138796679.html), causing serious problems for villagers who come to get Aadhaar-related work done. People have lost time, daily wages, and had to return without getting Aadhaar updates, meaning they have to plan a return visit and lose more entitlements in the meanwhile. 
...
* The Kerala High Court observed that [DigiYatra may not need Aadhaar](https://www.thehindu.com/news/national/kerala/digi-yatra-cannot-insist-on-aadhaar-as-proof-of-identity-says-kerala-hc/article71225528.ece) if other identity proof can be used, and has asked DigiYatra if any other ID can be used.  
  ...
  * If you think something is worth sharing widely, please share it with us and we will try to include it in the updates. @no2UID or email: contact@rethinkaadhaar.in
